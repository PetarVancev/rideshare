    ...
    <div className="has-bottom-bar">
      ...
      <Container className="blue-text how-to-use-container">
        ...
        <p>
          ...
          би сакале да добивате предлози со конкретни адреси за превземање и
          пристигање на патниците. (Пример: патникот сака да го превземете од
          неговиот дом)
        </p>
        ...
        <h3 className="heading-xxs">
          3. Потврдете кога ќе пристигнете на локацијата за превземање на
          патниците.
        </h3>
        <p>
          Кога ќе пристигнете на локацијата за превземање на патниците/патникот
