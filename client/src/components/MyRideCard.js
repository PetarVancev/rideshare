...
const MyRideCard = ({
  ...
  const confirmAtPickup = () => {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        async (position) => {
          try {
            ...
            toast.success("Successfully confirmed pickup location", {
              position: "top-center",
              autoClose: 2000,
              hideProgressBar: false,
              closeButton: true,
        ...
        (error) => {
          toast.dismiss();
          toast.error("Please enable location access and try again", {
            position: "top-center",
            autoClose: 2000,
            hideProgressBar: false,
            closeButton: true,
      ...
      toast.dismiss();
      toast.error(
        "Your browser does not allow access to your location, try via Google Chrome",
        {
          position: "top-center",
          autoClose: 2000,
          hideProgressBar: false,
      ...
      <Card.Body>
        ...
        <div className="date-info justify-content-center d-flex">
          ...
          <Col xs={6} className="px-3">
            ...
            <h4 className="body-bold-xs">{reservation.num_seats} Seat</h4>
          </Col>
        </div>
        ...
        {category === "R" && (
          <>
            ...
            >
              <span className="body-bold-s">Message {driver.name}</span>
        ...
        <Card.Body className="pb-0">
          ...
          {category != "R" && (
            <div className="d-flex justify-content-between">
              <h5 className="body-bold-xs blue-text">
      ...
      {proposals && category == "R" && (
        <>
          <span className="body-bold-medium blue-text">
            <img src="images/direction-icon.svg" /> Suggested locations from
            passengers
          </span>
          <Swiper
            slidesPerView={1}
      ...
      {category == "R" && (
        <Card className="my-ride-card mt-3">
          <Card.Body className="pb-0">
            ...
            >
              <h5 className="body-bold-xs blue-text">Passengers</h5>
