...
const MyRideCard = ({ token, userType, rideData, fetchRideData, category }) => {
  ...
  return userType === "passenger" ? (
    ...
    <div className="drivers-ride-wrapper mt-3 mb-3">
      <Card className="my-ride-card mt-0 mb-2">
      ...
      <Card className="my-ride-card mt-3">
        <Card.Body className="pb-0">
          <div className="d-flex justify-content-between">
            ...
            <strong className="body-bold-medium">мкд {ride.price}</strong>
          </div>
          <div
            ...
            <div className="passengers-list">
              {reservations.custom_location && (
                <div className="pb-4">
                  ...
                  {reservations.custom_location.map((reservation, index) => {
                    return (
                      <div
                        className="d-flex justify-content-between mx-3 blue-text pt-4"
                        key={index}
                      >
                        <span className="body-bold-medium">
                          {reservation.name}
                        </span>
          ...
          {/* <div className="d-flex justify-content-between">
            <h5 className="body-bold-xs">Надоместок по патник</h5>
            <strong>мкд {ride.price}</strong>
          </div> */}
        </Card.Body>
      </Card>
    </div>
